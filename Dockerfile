...
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2021b/Release/4/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2021b_Update_4_glnxa64.zip && \
